...
class CompanionService : Service() {
    ...
    private fun process(req:JSONObject,key:ByteArray):JSONObject{
        ...
        return when(req.optString("type")){
            ...
            "capabilities"->response.put("type","capabilities").put("notifications",false).put("files",true).put("camera",false).put("screen_control",false).put("app_inventory",true).put("remote_app_policy",true)
